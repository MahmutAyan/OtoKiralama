    ...
    public partial class frmSözleşme : Form
    {
        ...
        private void btnAraçTeslim_Click(object sender, EventArgs e)
        {
            if (int.Parse(txtEkstra.Text) >= 0 || int.Parse(txtEkstra.Text) < 0)
            {
                ...
                ///Toplamtutar,_gun ve ucret satış tablosuna akratılacak              
                ...
                string sorgu3 = "insert into satış(tc,adsoyad,plaka,marka,seri,yil,renk,gun,tutar,fiyat,tarih1,tarih2) values(@tc,@adsoyad,@plaka,@marka,@seri,@yil,@renk,@gun,@tutar,@fiyat,@tarih1,@tarih2) ";
                SqlCommand komut2 = new SqlCommand();
